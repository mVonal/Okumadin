# Trendyol — Hizmet Şartları ve Gizlilik Analizi

**İşletici:** DSM Grup Danışmanlık İletişim ve Satış Ticaret A.Ş.
**Merkez:** Maslak, Sarıyer, İstanbul
**Fiili Kontrol:** Alibaba Group Holding Limited (%86,5 hisse)
...
> kamuya açık resmi kaynaklara dayanmaktadır.
...
aşağıdakilerin tümünü kabul etmiş sayılırsınız:
...
| Dolap Gizlilik Politikası | Dolap kullanımında |
...
| Üçüncü taraf paylaşımı | 8 / 10 | %15 |
| Metadata/veri toplama kapsamı | 9 / 10 | %15 |
| KVKK uyumu | 4 / 10 | %20 |
| Belge şeffaflığı | 5 / 10 | %15 |
| Yetkili hukuk ve mahkeme | 2 / 10 | %15 |
| **Genel risk skoru** | **🟠 6,5 / 10** | |
...
### 2. Kayıtlı Kart Bilgileri Saklanıyor
...
### 3. Veri "İştirakler ve Grup Şirketleri" ile Paylaşılıyor
...
### 4. Yurt Dışına Veri Aktarımı Belgelenmiş

Aydınlatma Metni'nin 4.3 maddesinde "yurtdışında yerleşik
hizmet alınan hizmet sağlayıcılar, bilişim altyapısı ve
yazılım hizmeti sunan iştirakler ve grup şirketleri" ile
veri paylaşıldığı açıkça belirtilmektedir. Hangi ülkelerin
kapsam dahilinde olduğu belirtilmemiştir.

Aktarım mekanizması olarak KVKK madde 9 kapsamında
"standart sözleşme" yöntemi kullanıldığı ifade edilmektedir.

**Kaynak:** Aydınlatma Metni Madde 4.3
...
### Veri Saklama Süresi Belirtilmemiş

Ana Aydınlatma Metni'nde kişisel verilerin ne kadar
...
## 🔵 İstihbarat ve Yapısal Risk

### Çin Hukuku ve Alibaba Bağlantısı

Çin'in 2017 tarihli Siber Güvenlik Kanunu'nun 28.
maddesi ve 2021 tarihli Veri Güvenliği Kanunu'nun
35. maddesi, Çinli şirketlere kamu güvenliği veya
ulusal güvenlik gerekçesiyle devlet talepleri
karşısında veri ve teknik destek sağlama yükümlülüğü
getirmektedir. Bu yasal çerçeve Alibaba Group'un
tabi olduğu hukuk sisteminin bir parçasıdır.

Trendyol kendi belgelerinde "iştirakler ve grup
şirketleri" ile veri paylaşımını kabul etmektedir.
Bu iki olgu birlikte değerlendirildiğinde yapısal
bir risk profili oluşmaktadır.

Bu durum doğrudan bir ihlal iddiası değil,
kullanıcıların değerlendirmesi gereken yapısal
bir bilgidir.

**Kaynak:** Çin Siber Güvenlik Kanunu (2017) Madde 28 ·
Çin Veri Güvenliği Kanunu (2021) Madde 35 ·
Aydınlatma Metni Madde 4.1 ·
Ticaret Sicili Gazetesi (Mart 2021)
...
| Kriter | Durum |
|---|---|
| Aydınlatma yükümlülüğü | 🟢 Yerine getirilmiş |
...
> Not: Yerli olmak tek başına güvenli olmak anlamına
> gelmez. Hepsiburada analizi tamamlanana kadar
